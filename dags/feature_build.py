...
with DAG(
    ...
    dbt_features = DbtTaskGroup(
        ...
        project_config=ProjectConfig(dbt_project_path=DBT_PROJECT_DIR, install_dbt_deps=False),
        ...
        render_config=RenderConfig(
            ...
            # One task per model, its tests inside it: `dbt build`'s own semantics, and the same
            # thing `make features-sql` runs.
